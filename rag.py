...
class rag_gestor():
    ...
    """División de chunks de los documentos."""
    ...
    def get_embeddings(self,embedding_choice=None) -> HuggingFaceEmbeddings | GoogleGenerativeAIEmbeddings:
